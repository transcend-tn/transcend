            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <div className="flex justify-between items-center py-4 md:justify-start md:space-x-10">
                ...
                <Popover.Group as="nav" className="hidden md:flex space-x-10">
                  {navItems.map((item) => (
                    <Link href={item.href} key={item.href}>
                      <a className="px-3 py-2 rounded-md text-md font-medium text-gray-500 hover:text-gray-900">
                        {item.name}
                      </a>
                    </Link>
                  ))}
                ...
                <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                  <Link href="#contact">
                    <a className="uppercase flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-gray-600 rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-purple-200">
                      Contact us
                    </a>
                  </Link>
                </div>
